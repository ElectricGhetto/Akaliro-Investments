      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-stretch">
            <div className="flex flex-col gap-6 h-full">
                <img src="https://tufezgrcqbnxlqnzqsmc.supabase.co/storage/v1/object/public/Weekly/Akaliro/Akaliro%20Investments%20Team%20(2).webp" alt="Our Team" className="w-full flex-1 object-cover rounded-2xl shadow-lg" />
                <img src="https://tufezgrcqbnxlqnzqsmc.supabase.co/storage/v1/object/public/Weekly/Akaliro/Akaliro%20Investments%20About%20Us.webp" alt="Service Delivery" className="w-full flex-1 object-cover rounded-2xl shadow-lg" />
            </div>

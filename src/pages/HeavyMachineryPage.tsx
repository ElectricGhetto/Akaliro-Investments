  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white py-16 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-64 md:h-96 rounded-2xl overflow-hidden shadow-lg border border-gray-200">
            <img
              src="https://tufezgrcqbnxlqnzqsmc.supabase.co/storage/v1/object/public/Weekly/Akaliro/Akaliro-Plant-and-Machinery-3.jpg"
              alt="AKaliro Heavy Plant & Machinery"
      ...
      <div className="py-16 px-6 max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="relative h-64 md:h-96 rounded-2xl overflow-hidden shadow-lg border border-gray-200">
          <img
            src="https://tufezgrcqbnxlqnzqsmc.supabase.co/storage/v1/object/public/Weekly/Akaliro/Akaliro-Plant-and-Machinery-2.jpg"
            alt="AKaliro Preventive Maintenance Heavy Machinery"
            className="w-full h-full object-cover object-center hover:scale-105 transition-transform duration-500"
            loading="lazy"
            decoding="async"
          />
        ...
        <div>
          ...
          <p className="text-xl text-gray-700 leading-relaxed">
            Our dedicated mechanical engineering team enforces rigorous daily servicing and preventive maintenance schedules. This proactive regime avoids downtime, ensures safety compliance, and preserves peak equipment performance throughout project durations.
          </p>
        </div>
      </div>

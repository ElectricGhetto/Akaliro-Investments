      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-8">
            AKaliro Investments is a dedicated financial partner providing sustainable growth, tailored wealth management, and strategic market expertise. We leverage deep analytical insights to identify global opportunities, ensuring long-term prosperity through robust partnerships and innovative financial planning solutions.
          </p>
          <Link
            to="/about"

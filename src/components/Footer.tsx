    ...
    <footer className="bg-[#1d6000] text-white py-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col gap-4">
          <img src="https://tufezgrcqbnxlqnzqsmc.supabase.co/storage/v1/object/public/Weekly/Akaliro%20Investments.png" alt="Akaliro Logo" className="h-16 w-auto bg-white p-2 rounded-lg object-contain" />
